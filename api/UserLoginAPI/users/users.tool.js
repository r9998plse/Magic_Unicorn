...
const Email = require('../tools/email.tool.js')
...
UserTool.sendEmailConfirmKey = (user, email, email_confirm_key) => {
  ...
  text += 'Welcome! <br><br>'
  text +=
    "To confirm your email, click here: <br><a href='" +
    confirm_link +
    "'>" +
    confirm_link +
    '</a><br><br>'
...
UserTool.sendEmailChangeEmail = (user, email, new_email) => {
  ...
  text +=
    'If you believe this is an error, please contact support immediately.<br><br>'
  text += 'Thank you and see you soon!<br>'
...
UserTool.sendEmailPasswordRecovery = (user, email) => {
  ...
  text +=
    ...
    user.password_recovery_key.toUpperCase() +
    '<br><br>'
  text += 'Thank you and see you soon!<br>'
